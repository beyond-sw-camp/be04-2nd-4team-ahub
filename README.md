...
- **양지혜** : 서버를 고려하여 개발한다는 점이 굉장히 어렵게 다가왔습니다. 또한 프로그래밍 언어에 서툴어 팀원들에게 많은 도움을 받았습니다. 저는 다른 욕심보다는 이 프로젝트에서 1인분을 하고자 노력하였습니다. 저도 기능 구현 등을 좀 더 공부하여 해당 프로젝트를 고도화하고 싶습니다. 어제보다 오늘 더 노력하여 팀에서 필요한 역할을 할 수 있는 팀원이 되고자 노력하겠습니다.
